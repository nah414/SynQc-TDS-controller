...
**Post-Deployment:**
- [ ] Monitor backend metrics (CPU, memory, disk I/O)
- [ ] Verify flusher is persisting sessions
- [ ] Check for any agent suggestion errors in logs
- [ ] Validate frontend loads with attribution visible
